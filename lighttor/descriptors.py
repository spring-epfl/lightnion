...
if __name__ == '__main__':
    ...
    endpoint, descriptors = download(endpoint) # (microdescriptors)
    endpoint, undescriptors = download(endpoint, flavor='unflavored')
    ...
    endpoint, authority = download_authority(endpoint)
